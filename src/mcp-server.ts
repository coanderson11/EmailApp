...
// import { GetDailyBriefingTool, AddOpportunityTool, AddInsightTool, GetAgentQueriesTool, SynthesizeIntelligenceTool } from './mcp/tools/extensibility/intelligence-tools.js';
...
class MCPServer {
  ...
  private async initializeTools(): Promise<void> {
    ...
    const toolInstances = [
      ...
      // new GetDailyBriefingTool(this.userContext, prisma),
      // new AddOpportunityTool(this.userContext, prisma),
      // new AddInsightTool(this.userContext, prisma),
      // new GetAgentQueriesTool(this.userContext, prisma),
      // new SynthesizeIntelligenceTool(this.userContext, prisma),
    ];
